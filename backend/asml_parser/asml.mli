...
type t = 
  ...
  | Let of (Id.t * Type.t) * exp * t (** A Let definition followed by other
  [t] *)
...
and exp =
  ...
  | Add of Id.t * id_or_imm (** addition of a variable with an
  immediate/variable *)
  | Sub of Id.t * id_or_imm (** subtraction *)
  | Ld of Id.t * id_or_imm (** Load a value represented by imm/var into a var *)
